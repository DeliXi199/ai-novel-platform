...
export const state = {
  viewMode: isCreateRoute ? "create" : "studio",
  novels: [],
...
export const refs = {
  ...
  createTaskHistoryPanel: document.getElementById("createTaskHistoryPanel"),
  createTaskHistoryMeta: document.getElementById("createTaskHistoryMeta"),
  createTaskHistoryList: document.getElementById("createTaskHistoryList"),
  ...
  storyWorkspaceHighlights: document.getElementById("storyWorkspaceHighlights"),
