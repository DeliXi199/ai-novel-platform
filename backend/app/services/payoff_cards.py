...
def build_payoff_cards() -> list[dict[str, Any]]:
    return [
...

        {
            ...
            "payoff_visibility": "public",
            "execution_cost": "medium",
            "applicable_event_types": ["交易类", "关系推进类", "冲突类"],
            "applicable_progress_kinds": ["关系推进", "资源推进"],
            "compatible_flows": ["trade_exchange", "authority_collision", "verify_then_strike"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["public", "semi_public"],
            "protagonist_positions": ["balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["改价", "众目", "重新报价", "当众", "松口"],
            "reader_payoff": "让对方在众目睽睽下被迫重开条件，读者能明显感觉主角抬高了身价。",
            "new_pressure": "当众改价会让更多人重新打量主角。",
            "aftershock": "后续会有人想复制、拆台或直接绕过这次改价结果。",
            "external_reaction": "必须有人改口、沉默、换称呼或重新排位。",
            "anti_repeat_key": "public_reprice",
        },
        {
            "card_id": "payoff_false_loss_real_gain",
            "name": "假损实赚",
            "family": "智谋",
            "payoff_mode": "假损实赚",
            "payoff_level": "medium",
            "payoff_visibility": "semi_public",
            "execution_cost": "medium",
            "applicable_event_types": ["反制类", "交易类", "发现类"],
            "applicable_progress_kinds": ["信息推进", "资源推进"],
            "compatible_flows": ["bait_then_capture", "small_win_trap", "trade_exchange"],
            "applicable_stages": ["opening", "early_mid", "mid"],
            "scene_visibility": ["semi_public", "private"],
            "protagonist_positions": ["weak", "balanced"],
            "requires_pressure_debt": False,
            "keyword_hints": ["看似吃亏", "假损", "实赚", "放出去", "绕回来"],
            "reader_payoff": "表面上像让出去一点，实际上关键收益被主角悄悄锁住了。",
            "new_pressure": "对手一旦回过味来，会立刻补追或改打法。",
            "aftershock": "结尾最好让读者先爽到，再意识到这手不能连用。",
            "external_reaction": "至少写出一方先轻敌、后起疑的变化。",
            "anti_repeat_key": "false_loss_real_gain",
        },
        {
            "card_id": "payoff_witness_reversal",
            "name": "证人改口",
            "family": "关系",
            "payoff_mode": "旁证翻转",
            "payoff_level": "strong",
            "payoff_visibility": "public",
            "execution_cost": "medium",
            "applicable_event_types": ["冲突类", "发现类", "关系推进类"],
            "applicable_progress_kinds": ["关系推进", "信息推进"],
            "compatible_flows": ["verify_then_strike", "discover_secret", "authority_collision"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["public", "semi_public"],
            "protagonist_positions": ["balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["证人", "改口", "旁证", "站队", "翻转"],
            "reader_payoff": "原本不站主角的人被迫改口或偏站，形成很直接的翻盘感。",
            "new_pressure": "证人一改口，背后立场和旧关系都会被牵出来。",
            "aftershock": "后续要有人追问证人为何改口，或开始查主角手里还有什么。",
            "external_reaction": "必须有围观者意识到风向已经变了。",
            "anti_repeat_key": "witness_reversal",
        },
        {
            "card_id": "payoff_deadline_reverse",
            "name": "反借时限",
            "family": "智谋",
            "payoff_mode": "时限反压",
            "payoff_level": "strong",
            "payoff_visibility": "semi_public",
            "execution_cost": "medium",
            "applicable_event_types": ["危机爆发", "交易类", "外部任务类"],
            "applicable_progress_kinds": ["风险升级", "关系推进"],
            "compatible_flows": ["pressure_close", "forced_choice", "authority_collision"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["semi_public", "public"],
            "protagonist_positions": ["weak", "balanced"],
            "requires_pressure_debt": True,
            "keyword_hints": ["时限", "反借", "赶在之前", "倒计时", "逼回去"],
            "reader_payoff": "原本压在主角头上的时限被主角反过来用成逼人松口的工具。",
            "new_pressure": "这种反借时限会让后续时间更紧，也更容易暴露底牌。",
            "aftershock": "结尾最好把‘赢了这一口气，但时间真的更少了’写出来。",
            "external_reaction": "对面至少出现一次明显被打乱节奏的反应。",
            "anti_repeat_key": "deadline_reverse",
        },
        {
            "card_id": "payoff_secret_control",
            "name": "暗拿控制权",
            "family": "资源",
            "payoff_mode": "低调掌控",
            "payoff_level": "medium",
            "payoff_visibility": "private",
            "execution_cost": "low",
            "applicable_event_types": ["发现类", "交易类", "资源获取类"],
            "applicable_progress_kinds": ["资源推进", "信息推进"],
            "compatible_flows": ["calm_hidden_needle", "trade_exchange", "bait_then_capture"],
            "applicable_stages": ["opening", "early_mid", "mid", "late"],
            "scene_visibility": ["private", "semi_public"],
            "protagonist_positions": ["weak", "balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["暗拿", "控制权", "悄悄掌控", "钥匙", "通路"],
            "reader_payoff": "主角没有高调出风头，但悄悄把关键钥匙、通路或决定权抓到了手里。",
            "new_pressure": "控制权一到手，隐藏和使用的难度立刻上升。",
            "aftershock": "后续要围绕保密、调度和被察觉风险继续推进。",
            "external_reaction": "即便没人看见，也要让主角的路线和计划立刻改变。",
            "anti_repeat_key": "secret_control",
        },
        {
            "card_id": "payoff_favor_lock",
            "name": "人情锁账",
            "family": "关系",
            "payoff_mode": "人情落账",
            "payoff_level": "medium",
            "payoff_visibility": "semi_public",
            "execution_cost": "low",
            "applicable_event_types": ["关系推进类", "危机爆发", "交易类"],
            "applicable_progress_kinds": ["关系推进", "资源推进"],
            "compatible_flows": ["debt_collect", "rescue_under_cost", "cooperate_break"],
            "applicable_stages": ["opening", "early_mid", "mid", "late"],
            "scene_visibility": ["private", "semi_public", "public"],
            "protagonist_positions": ["weak", "balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["人情", "记账", "欠下", "锁住", "回头"],
            "reader_payoff": "这一章不一定拿到硬资源，但把一笔会在后面起作用的人情真正锁住了。",
            "new_pressure": "人情一旦落账，也意味着后续关系更复杂、更难退。",
            "aftershock": "结尾最好点出这笔账未来会在哪个方向爆出来。",
            "external_reaction": "至少要有人意识到主角和某人的关系已经不再是原来的价位。",
            "anti_repeat_key": "favor_lock",
        },
        {
            "card_id": "payoff_public_calm_silence",
            "name": "静场压众",
            "family": "气场",
            "payoff_mode": "静场压众",
            "payoff_level": "strong",
            "payoff_visibility": "public",
            "execution_cost": "medium",
            "applicable_event_types": ["冲突类", "危机爆发", "关系推进类"],
            "applicable_progress_kinds": ["关系推进", "风险升级"],
            "compatible_flows": ["authority_collision", "conflict_upgrade", "breakthrough_grow"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["public", "semi_public"],
            "protagonist_positions": ["balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["静场", "压住", "一静", "没人再插嘴", "场面定住"],
            "reader_payoff": "不用多说，主角只靠一次动作、一次眼神或一句话就把场面静住。",
            "new_pressure": "静住场面后，主角会立刻被更高位的人记住。",
            "aftershock": "后续最好接‘谁开始重新估量主角’。",
            "external_reaction": "必须让周围人明显静下、退一步或改口。",
            "anti_repeat_key": "public_calm_silence",
        },
        {
            "card_id": "payoff_old_hook_cashout",
            "name": "旧钩现收",
            "family": "回收",
            "payoff_mode": "旧钩回收",
            "payoff_level": "strong",
            "payoff_visibility": "semi_public",
            "execution_cost": "medium",
            "applicable_event_types": ["关系推进类", "发现类", "交易类"],
            "applicable_progress_kinds": ["信息推进", "关系推进", "资源推进"],
            "compatible_flows": ["debt_collect", "discover_secret", "hidden_alliance_shift"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["private", "semi_public", "public"],
            "protagonist_positions": ["weak", "balanced", "strong"],
            "requires_pressure_debt": True,
            "keyword_hints": ["旧钩", "终于应验", "回收", "前文", "兑现"],
            "reader_payoff": "把前面挂着的一条旧钩真正收回来，会让读者有很扎实的满足感。",
            "new_pressure": "旧钩一收，往往会带出新的、更难的问题。",
            "aftershock": "结尾不要只停在满足感上，要把新的账顺手挂出来。",
            "external_reaction": "最好让至少一个角色意识到：前面的那件事现在终于生效了。",
            "anti_repeat_key": "old_hook_cashout",
        },
        {
            "card_id": "payoff_false_retreat_real_gain",
            "name": "佯退实拿",
            "family": "智谋",
            "payoff_mode": "假退真赢",
            "payoff_level": "medium",
            "payoff_visibility": "semi_public",
            "execution_cost": "low",
            "applicable_event_types": ["交易类", "关系推进类", "反制类"],
            "applicable_progress_kinds": ["资源推进", "关系推进"],
            "compatible_flows": ["retreat_for_better_position", "trade_exchange", "status_probe"],
            "applicable_stages": ["opening", "early_mid", "mid", "late"],
            "scene_visibility": ["private", "semi_public", "public"],
            "protagonist_positions": ["weak", "balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["佯退", "看似吃亏", "实拿", "换位", "转赢"],
            "reader_payoff": "表面像退了一步，实际上主角把更值钱的位置、筹码或信息抓到了手里。",
            "new_pressure": "别人会重新估量主角到底是真退还是真在算账。",
            "aftershock": "下一章可顺着‘谁看懂了这手、谁没看懂’继续发酵。",
            "external_reaction": "至少要有人先以为主角退了，随后才发现自己算错。",
            "anti_repeat_key": "false_retreat_real_gain",
        },
        {
            "card_id": "payoff_witness_revalues",
            "name": "见证改价",
            "family": "气场",
            "payoff_mode": "见证改价",
            "payoff_level": "strong",
            ...
            "applicable_event_types": ["冲突类", "发现类", "关系推进类"],
            "applicable_progress_kinds": ["关系推进", "信息推进"],
            "compatible_flows": ["witness_reversal", "authority_collision", "rumor_turn_real"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["public", "semi_public"],
            "protagonist_positions": ["balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["见证", "改价", "改观", "目击", "重新估值"],
            "reader_payoff": "不是主角自说自话，而是见证者真的改了对主角的价码和判断。",
            "new_pressure": "一旦被更多人重新估价，主角的麻烦和机会都会一起抬高。",
            "aftershock": "后续最好接到谁开始主动找上主角或主动防主角。",
            "external_reaction": "必须有可见的改口、让位、迟疑或重新称呼。",
            "anti_repeat_key": "witness_revalues",
        },
        {
            "card_id": "payoff_half_secret_locked",
            "name": "半秘锁手",
            "family": "信息",
            "payoff_mode": "半秘到手",
            "payoff_level": "medium",
            "payoff_visibility": "private",
            "execution_cost": "low",
            "applicable_event_types": ["发现类", "交易类", "潜入类"],
            "applicable_progress_kinds": ["信息推进", "资源推进"],
            "compatible_flows": ["discover_secret", "bait_then_capture", "lure_enemy_exposure"],
            "applicable_stages": ["opening", "early_mid", "mid", "late"],
            "scene_visibility": ["private", "semi_public"],
            "protagonist_positions": ["weak", "balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["半秘", "锁手", "只拿一半", "钥匙", "缺一格"],
            "reader_payoff": "主角拿到了真正能用的一半秘密或钥匙，不是空泛知道‘有问题’。",
            "new_pressure": "知道这半格之后，主角必须更快决定要不要继续追或先藏。",
            "aftershock": "结尾最好落在‘知道半格后路线立刻改变’上。",
            "external_reaction": "即便私密，也要让主角的判断和下一步动作明显改变。",
            "anti_repeat_key": "half_secret_locked",
        },
        {
            "card_id": "payoff_rule_backhand",
            "name": "规条反扣",
            "family": "智谋",
            "payoff_mode": "借规反扣",
            "payoff_level": "strong",
            "payoff_visibility": "semi_public",
            "execution_cost": "medium",
            "applicable_event_types": ["交易类", "冲突类", "发现类"],
            "applicable_progress_kinds": ["信息推进", "关系推进", "风险升级"],
            "compatible_flows": ["verify_then_strike", "authority_collision", "trade_exchange"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["semi_public", "public"],
            "protagonist_positions": ["weak", "balanced", "strong"],
            "requires_pressure_debt": True,
            "keyword_hints": ["规条", "反扣", "借规矩", "按条压回去", "程序"],
            "reader_payoff": "主角不靠蛮横，而是把别人原本拿来压人的规条反扣了回去。",
            "new_pressure": "这会直接引来更高位的人、更多条文或更细的审视。",
            "aftershock": "后续可以接更高层规矩、身份或资格问题。",
            "external_reaction": "必须有人被迫改口、补条件或认下程序上的被动。",
            "anti_repeat_key": "rule_backhand",
        },
        {
            "card_id": "payoff_debt_repriced",
            "name": "旧账改价",
            "family": "回收",
            "payoff_mode": "旧账抬价",
            "payoff_level": "medium",
            "payoff_visibility": "semi_public",
            "execution_cost": "low",
            "applicable_event_types": ["关系推进类", "交易类"],
            "applicable_progress_kinds": ["关系推进", "资源推进"],
            "compatible_flows": ["debt_collect", "favor_exchange_entry", "hidden_alliance_shift"],
            "applicable_stages": ["opening", "early_mid", "mid", "late"],
            "scene_visibility": ["private", "semi_public", "public"],
            "protagonist_positions": ["weak", "balanced", "strong"],
            "requires_pressure_debt": True,
            "keyword_hints": ["旧账", "改价", "抬价", "回收", "账本"],
            "reader_payoff": "旧账不是简单还上，而是被主角借机改成了更值钱的新条件。",
            "new_pressure": "价码一变，关系也会更难回到原先的轻松状态。",
            "aftershock": "适合顺带挂出下一次兑现或反噬。",
            "external_reaction": "至少让一个当事人意识到：这笔账现在不按老价算了。",
            "anti_repeat_key": "debt_repriced",
        },
        {
            "card_id": "payoff_public_name_rises",
            "name": "名位上浮",
            "family": "气场",
            "payoff_mode": "名位抬升",
            "payoff_level": "strong",
            ...
            "applicable_event_types": ["冲突类", "危机爆发", "关系推进类"],
            "applicable_progress_kinds": ["关系推进", "风险升级"],
            "compatible_flows": ["authority_collision", "status_probe", "breakthrough_grow"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["public", "semi_public"],
            "protagonist_positions": ["balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["名位", "上浮", "名声", "份量", "被记住"],
            "reader_payoff": "这一章结束后，主角在别人心里的位置明显更高了。",
            "new_pressure": "名位一抬，嫉恨、试探和利用都会随之增加。",
            "aftershock": "后续最好接谁开始主动找主角、盯主角或压主角。",
            "external_reaction": "必须让多人对主角的称呼、态度或优先级出现位移。",
            "anti_repeat_key": "public_name_rises",
        },
        {
            "card_id": "payoff_hidden_route_secured",
            "name": "暗路先得",
            "family": "资源",
            "payoff_mode": "暗路到手",
            "payoff_level": "medium",
            "payoff_visibility": "private",
            "execution_cost": "low",
            "applicable_event_types": ["外部任务类", "发现类", "交易类"],
            "applicable_progress_kinds": ["资源推进", "信息推进"],
            "compatible_flows": ["favor_exchange_entry", "hidden_alliance_shift", "split_route_parallel"],
            "applicable_stages": ["opening", "early_mid", "mid", "late"],
            "scene_visibility": ["private", "semi_public"],
            "protagonist_positions": ["weak", "balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["暗路", "通路", "提前拿到", "后门", "捷径"],
            "reader_payoff": "主角先于别人掌握了一条暗路、侧门或备用通路。",
            "new_pressure": "暗路越值钱，越需要防走漏和防反制。",
            "aftershock": "后续适合接藏线、抢位或别人追查通路来源。",
            "external_reaction": "至少要让主角的行动空间马上变得更宽。",
            "anti_repeat_key": "hidden_route_secured",
        },
        {
            "card_id": "payoff_partial_reverse_face",
            "name": "半翻旧脸",
            "family": "关系",
            "payoff_mode": "旧脸翻面",
            "payoff_level": "medium",
            "payoff_visibility": "semi_public",
            "execution_cost": "low",
            "applicable_event_types": ["关系推进类", "冲突类"],
            "applicable_progress_kinds": ["关系推进"],
            "compatible_flows": ["conflict_bond", "relationship_warm", "witness_reversal"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["private", "semi_public", "public"],
            "protagonist_positions": ["weak", "balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["翻脸", "改观", "旧印象", "态度变了", "半翻"],
            "reader_payoff": "原本看轻或看错主角的人，这章终于被迫改了半张脸。",
            "new_pressure": "改观不是完全归顺，反而会带来新的试探与靠近。",
            "aftershock": "后续适合接合作、试探或再一次错判。",
            "external_reaction": "至少有一句改口、一次迟疑或一个位置变化能看出来。",
            "anti_repeat_key": "partial_reverse_face",
        },
        {
            "card_id": "payoff_bait_paid_back",
            "name": "鱼已上钩",
            "family": "智谋",
            "payoff_mode": "诱饵见效",
            "payoff_level": "strong",
            "payoff_visibility": "semi_public",
            "execution_cost": "medium",
            "applicable_event_types": ["反制类", "发现类", "潜入类"],
            "applicable_progress_kinds": ["信息推进", "风险升级"],
            "compatible_flows": ["bait_then_capture", "lure_enemy_exposure", "fail_forward_clue"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["private", "semi_public"],
            "protagonist_positions": ["balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["上钩", "诱饵见效", "反应来了", "钓出来了", "露头"],
            "reader_payoff": "之前埋下的诱饵这章终于见效，真把人、线索或反应钓了出来。",
            "new_pressure": "鱼既然上钩，就要承担继续追、继续钓或被反咬的压力。",
            "aftershock": "结尾最好落在‘现在得决定追到哪’。",
            "external_reaction": "至少要有一个具体反应能证明诱饵不是白放。",
            "anti_repeat_key": "bait_paid_back",
        },
        {
            "card_id": "payoff_hidden_cost_exposed",
            "name": "代价亮边",
            "family": "资源",
            "payoff_mode": "代价显边",
            "payoff_level": "medium",
            "payoff_visibility": "semi_public",
            "execution_cost": "low",
            "applicable_event_types": ["资源获取类", "突破类", "交易类"],
            "applicable_progress_kinds": ["资源推进", "风险升级"],
            "compatible_flows": ["resource_gain", "rescue_under_cost", "false_safe_window"],
            "applicable_stages": ["early_mid", "mid", "late"],
            "scene_visibility": ["private", "semi_public"],
            "protagonist_positions": ["weak", "balanced", "strong"],
            "requires_pressure_debt": False,
            "keyword_hints": ["代价", "亮边", "不白拿", "后患露边", "账来了"],
            "reader_payoff": "主角确实拿到了好处，但读者同时清楚看见这份好处的边角已经开始割手。",
            "new_pressure": "这份代价会在接下来的判断里马上形成约束。",
            "aftershock": "适合把下一章推进直接绑到‘怎么处理代价’上。",
            "external_reaction": "最好有人或主角自己立刻意识到这份代价不是以后再说。",
            "anti_repeat_key": "hidden_cost_exposed",
        },
    ]
...
def ensure_payoff_library(story_bible: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    roadmap.setdefault("payoff_card_target_count", 40)
...
def _normalize_ai_selector_payload(
    ...
    *,
    ...
    allowed_ids = {_text(item.get("card_id")) for item in candidates if _text(item.get("card_id"))}
    payload = data or {}
    ...
    if not allowed_ids:
        raise GenerationError(
            ...
            message="payoff_card_selector 失败：当前没有可供 AI 终选的爽点候选。",
    ...
    if selected_card_id not in allowed_ids:
        raise GenerationError(
            code=ErrorCodes.MODEL_RESPONSE_INVALID,
            message="payoff_card_selector 失败：AI 返回了不在压缩候选索引中的爽点卡编号。",
            stage="payoff_card_selector",
            retryable=True,
            http_status=422,
            provider=provider_name(),
            details={"selected_card_id": selected_card_id, "allowed_ids": sorted(allowed_ids)},
        )
    ...
    return {
        ...
        "reason": _truncate_text(payload.get("reason"), 96) or "AI 已基于压缩爽点候选索引完成终选。",
        "execution_hint": _truncate_text(payload.get("execution_hint"), 96),
    }



def select_payoff_card_from_candidate_index(
    *,
    chapter_plan: dict[str, Any],
    payoff_candidate_index: dict[str, Any],
    shortlist_card_ids: list[str] | None = None,
    ...
    candidate_index = payoff_candidate_index or {}
    all_candidates = [item for item in (candidate_index.get("candidates") or []) if isinstance(item, dict)]
    if not all_candidates:
        raise GenerationError(
            code=ErrorCodes.MODEL_RESPONSE_INVALID,
            message="payoff_card_selector 失败：当前没有可供选择的爽点候选。",
            stage="payoff_card_selector",
            retryable=True,
            http_status=422,
            provider=provider_name(),
        )
    allowed_shortlist = {_text(item) for item in (shortlist_card_ids or []) if _text(item)}
    compressed_candidates = [item for item in all_candidates if not allowed_shortlist or _text(item.get("card_id")) in allowed_shortlist]
    if not compressed_candidates:
        raise GenerationError(
            code=ErrorCodes.MODEL_RESPONSE_INVALID,
            message="payoff_card_selector 失败：AI shortlist 未命中任何爽点压缩候选。",
            stage="payoff_card_selector",
            retryable=True,
            http_status=422,
            provider=provider_name(),
            details={"shortlist_card_ids": sorted(allowed_shortlist)},
        )
    diagnostics = candidate_index.get("diagnostics") or {}
    compensation = diagnostics.get("payoff_compensation") or chapter_plan.get("payoff_compensation") or {}
    timeout_seconds = request_timeout_seconds or max(int(getattr(settings, "payoff_ai_selection_timeout_seconds", 20) or 20), 10)
    try:
        data = call_json_response(
            ...
            user_prompt=payoff_card_selector_user_prompt(
                ...
                payoff_candidate_index={
                    ...
                    "candidate_count": len(compressed_candidates),
                    "compression_mode": candidate_index.get("compression_mode") or "compact_payoff_index",
                },
        ...
        if isinstance(data, dict):
            return _normalize_ai_selector_payload(data, candidates=compressed_candidates)
        raise GenerationError(
            code=ErrorCodes.MODEL_RESPONSE_INVALID,
...
def build_payoff_candidate_index(
    *,
    ...
    return {
        ...
        "compression_mode": "compact_payoff_index",
    }
